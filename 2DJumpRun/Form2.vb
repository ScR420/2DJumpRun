Public Class Level2
    ...
    Private Sub Form2_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        ...
        If PboxMain.Bounds.IntersectsWith(PboxBlock1.Bounds) OrElse PboxMain.Bounds.IntersectsWith(PboxBlock2.Bounds) OrElse PboxMain.Bounds.IntersectsWith(PBoxBlock3.Bounds) OrElse PboxMain.Bounds.IntersectsWith(pboxBlock4.Bounds) Then
            xPosition = 49
            yPosition = 332
            UpdatePosition()
        End If
        If PboxMain.Bounds.IntersectsWith(pboxTeleport1.Bounds) Then
            ...
            UpdatePosition()
        End If
        If PboxMain.Bounds.IntersectsWith(pboxTeleport3.Bounds) Then
            xPosition = 545
            yPosition = 330
            UpdatePosition()
        End If
    ...
    Private Sub finish()
        If PboxMain.Bounds.IntersectsWith(PboxFinish.Bounds) Then
            MessageBox.Show("Herzlichen Glückwunsch! Bereit fürs letzte level?")
            Me.Hide()
            Level3.Show()
